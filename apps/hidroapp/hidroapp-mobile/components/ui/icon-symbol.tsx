...
const MAPPING = { "house.fill": "water-drop", "chart.bar.fill": "bar-chart", "gearshape.fill": "settings" } as const satisfies Record<string, ComponentProps<typeof MaterialIcons>["name"]>;
