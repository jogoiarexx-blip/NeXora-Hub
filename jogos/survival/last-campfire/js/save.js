...
function defaultSave(){
  return {
    ...
    achievements: {},
    stats: { totalWoodBurned:0, nightsSurvived:0, bestTime:0, bestStreak:0, totalWeather:0, campaignWins:0 },
    campaign: { night:1, completed:false, streak:0 },
    settings: { sound:true, vibe:true, volume:0.6, quality:'auto' }
  };
}
let save = loadSave();
function loadSave(){
  try{
    ...
    return Object.assign(d, parsed, {
      ...
      campaign: Object.assign(d.campaign, parsed.campaign||{})
    });
...
const ACHIEVEMENTS = [
  ...
  { key:'survive10min', icon:'⏱', name:'Resistente', desc:'Sobreviva 6 minutos em uma partida' },
  ...
  { key:'campaign10', icon:'🏕️', name:'Guardião do Amanhecer', desc:'Conclua as 10 noites da campanha' },
  { key:'combo8', icon:'🔥', name:'Fogo Frenético', desc:'Alcance combo x8 alimentando a fogueira' },
];
