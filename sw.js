const SHELL = 'nexora-shell-v4';
const CONTENT = 'nexora-content-v4';
const SHELL_FILES = [
  './', './index.html', './css/style.css?v=4', './js/data-livros.js?v=4',
  './js/data-jogos.js?v=4', './js/data-apps.js?v=4', './js/offline-assets.js?v=4',
  './js/app.js?v=4', './assets/favicon.png', './assets/logo.png',
  './assets/icon-192.png', './assets/icon-512.png', './manifest.webmanifest?v=4'
];
